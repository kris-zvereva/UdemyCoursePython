...
print(id(a))  # location in memory, same output. a and b are names for same object
print(id(b))
...
print(
    id(b)
)  # Different, because we didn't change 8597.
# We just used the name 'a' for a different value. 'b' still is a name for 8597.

# Most things are mutable in Python.
