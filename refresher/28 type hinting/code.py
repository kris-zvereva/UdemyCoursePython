...
def list_avg(sequence: List) -> float:  # returns a float
...
class Book:
    ...
    @classmethod
    def hardcover(cls, name: str, page_weight: int) -> "Book":  # returns an object of the same type you're currently in
